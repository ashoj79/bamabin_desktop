...
class _Poster extends StatelessWidget {
  const _Poster({
    ...
    required this.showSummaryOnHover,
    required this.onTap,
    this.onDeleteTap,
  });
                    ...
                    Positioned(
                      ...
                      child: Directionality(
                        ...
                        child: Row(
                          ...
                          children: [
                            const _BadgeIcon(
                              asset: 'assets/img/post_subtitle.svg',
                            ),
                            if (post.hasAudio) ...[
                              const SizedBox(width: 2),
                              const _BadgeIcon(
                                asset: 'assets/img/post_dubbed.svg',
                              ),
                            ],
                          ],
                        ),
